...
## -----------------------------------------------------------------------------
e043 <- clugen(3, 4, 400, c(1, 0, 0), 0, c(10, 10, 10), 15, 1.5, 0.5, seed = seed)
e044 <- clugen(3, 4, 400, c(1, 1, 1), 0, c(10, 10, 10), 15, 1.5, 0.5, seed = seed)
e045 <- clugen(3, 4, 400, c(0, 0, 1), 0, c(10, 10, 10), 15, 1.5, 0.5, seed = seed)
...
## -----------------------------------------------------------------------------
e046 <- clugen(3, 6, 700, c(1, 0, 0), 0, c(10, 10, 10), 15, 1.5, 0.5, seed = seed)
e047 <- clugen(3, 6, 700, c(1, 0, 0), pi / 8, c(10, 10, 10), 15, 1.5, 0.5, seed = seed)
e048 <- clugen(3, 6, 700, c(1, 0, 0), 0, c(10, 10, 10), 15, 1.5, 0.5, seed = seed,
...
## -----------------------------------------------------------------------------
e049 <- clugen(3, 5, 700, dirs, 0, rep.int(0, 3), 20, 0, 0.25, seed = seed)
e050 <- clugen(3, 5, 700, dirs, pi / 12, rep.int(0, 3), 20, 0, 0.25, seed = seed)
e051 <- clugen(3, 5, 700, dirs, pi / 4, rep.int(0, 3), 20, 0, 0.25, seed = seed)
...
## -----------------------------------------------------------------------------
e052 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 0, 0, 0.5,
               seed = seed, point_dist_fn = "n")
e053 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 10, 0, 0.5,
               seed = seed, point_dist_fn = "n")
e054 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 30, 0, 0.5,
               seed = seed, point_dist_fn = "n")
...
## -----------------------------------------------------------------------------
e055 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 15,  0.0, 0.5,
               seed = seed, point_dist_fn = "n")
e056 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 15, 10.0, 0.5,
               seed = seed, point_dist_fn = "n")
e057 <- clugen(3, 5, 600, c(1, 0, 0), pi / 10, c(10, 10, 10), 10,  0.1, 0.5,
...
## -----------------------------------------------------------------------------
e058 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(30, 10, 10), 25, 4, 3, seed = seed)
e059 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(10, 30, 10), 25, 4, 3, seed = seed)
e060 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(10, 10, 30), 25, 4, 3, seed = seed)
...
## -----------------------------------------------------------------------------
e061 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed)
e062 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed,
               cluster_offset = c(20, -20, 20))
e063 <- clugen(3, 8, 700, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed,
